...
- Match: 11767 (93.93%)
- Differ: 760, of which 279 are files tsgo parses without diagnostics; the rest are deliberately invalid inputs where only error recovery differs
- No dump: 0
- Spans compared: no
...
| ----- | ----------------------------------------------------------------------------- |
| 74    | `SourceFile extra ExpressionStatement`                                        |
